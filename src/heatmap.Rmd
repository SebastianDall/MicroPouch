...
```{r}
ggarrange(gg_heat_fmt, gg_heat_placebo, ncol = 2, widths = c(3,2), labels = c("A", "B"))
ggsave("../figures/metaphlan4/heatmap/heatmap_pre_post_fmt_placebo.png", device = "png", width = 172, height = 81, units = "mm", dpi = 450, create.dir = T)
```
