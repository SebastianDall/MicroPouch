...
ggsave("../figures/metaphlan4/heatmap_pre_donor_weight-hellinger.png", device = "png", width = 12, height = 10)
```
...
ggsave("../figures/metaphlan4/heatmap_post_weight-hellinger.png", device = "png", width = 9, height = 10)
```
