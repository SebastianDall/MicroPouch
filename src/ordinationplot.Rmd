...
```{r}
metadata_in_metaplan <- metadata %>%
  filter(sample_barcode %in% colnames(metaphlan))

metadata_MP <- metadata_in_metaplan %>% 
...
ggsave("../figures/metaplhan4/ordination/pca_hellinger_all.png", device = "png", width = 7, height = 5)
```
...
ggsave("../figures/metaphlan4/ordination/amp_rda_hellinger_no_donor.png", device = "png")
```
