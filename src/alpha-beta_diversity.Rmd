...
metadata <- read_delim("../data/metadata/metadata.csv", delim = ";", show_col_types = FALSE, col_types = list(batch_3 = col_double())) %>% 
...
# new_metadata_beta_bray_FMT_and_placebo <- createANDcombineComparedOutputs(new_metadata_MP, new_metadata_beta_bray)
# new_metadata_beta_bray_summarised <- new_metadata_beta_bray_FMT_and_placebo %>%
#   summariseBetaDiversityOutput()
