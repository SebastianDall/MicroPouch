...
The ggplot code can be found in `functions/gg_functions.R`.
...
```{r}
metadata_beta_FMT_and_placebo <- bind_rows(
  compareFMT2ActualDonor(metadata_MP, metadata_beta),
  compareFMT2DonorNotReceived(metadata_MP, metadata_beta),
  comparePlacebo2DonorNotReceived(metadata_MP, metadata_beta)
)
```


```{r}
metadata_beta_summarised <- metadata_beta_FMT_placebo %>% # bind_rows(metadata_beta_FMT, metadata_beta_placebo) %>%
