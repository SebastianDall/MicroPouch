...
```{r}
metadata <- read_dta("../data/metadata/stata/metadata_mp.dta") %>% 
  mutate(project = "MP") %>% 
  fill(randomization_group)

metadata_op <- read_dta("../data/metadata/stata/metadata_op.dta") %>% 
  mutate(project = "OP")

metadata_np <- read_dta("../data/metadata/stata/metadata_np.dta") %>% 
  mutate(project = "NP") %>% 
